...
The backend of the application is built with NodeJS and ExpressJS and uses a MongoDB database to store the product and user data. The source code for the backend can be found at [https://github.com/SuperStar0718/MERN-E-Commerce-Backend](https://github.com/SuperStar0718/MERN-E-Commerce-Backend).
...
1. Clone the repository:
   ...
   ```
   git clone https://github.com/SuperStar0718/MERN-E-Commerce-Frontend.git
   ```
